...
use ihacklog\sms\models\SmsTemplateSearch;
...
class SmsTemplateController extends Controller
{
    ...
    {    
        ...
        $templateTypeArr = SmsTemplate::getTemplateTypeArr();
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    'forceReload'=>'true',
                    'title'=> "Create new SmsTemplate",
                    'content'=>'<span class="text-success">Create SmsTemplate success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    /**
     * Delete an existing SmsTemplate model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing SmsTemplate model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param string $id
     * @return mixed
    ...
    {        
        ...
        foreach (SmsTemplate::findAll(json_decode($pks)) as $model) {
            $model->delete();
        }
